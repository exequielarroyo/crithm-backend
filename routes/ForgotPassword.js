        ...
        <table class="outer" align="center">
          ...
          <tr>
            <td style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; text-align: center">
              <h1 style="margin-bottom: 50px; color: #3291a4">We Have Recieved Your Email</h1>
              <p style="font-size: large; color: rgb(203, 203, 203)">
              Your message request has been submitted to Crithm Support. <br />
              Once a support agent has responded to your message, <br />
              you will receive a notification email sent to:
              </p>
              <p style="margin-bottom: 50px; font-size: medium">${req.body.email}</p>
              <p style="margin-bottom: 20px; margin-top: 50px; font-size: medium; color: rgb(203, 203, 203)">
              This email is automatically generated by Crithm support <br />
              when someone with/without a Crithm account contacts our <br />
              Support team. 
              </p>
              <p style="margin-bottom: 50px; font-size: medium; color: rgb(203, 203, 203)">
              If you did not try to contact Crithm Support <br />
              you can simply ignore and delete this email, <br />
              someone likely entered their email incorrectly.
              </p>
            </td>
          </tr>
